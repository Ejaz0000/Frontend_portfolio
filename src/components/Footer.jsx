...
function Footer() {
  return (
    <div className="w-full flex justify-center py-5 lg:py-10 border-t-2 border-[#393e46] gap-10">
        <a href='https://www.facebook.com/profile.php?id=100017262407131' className='bg-[#393e46] p-3 rounded-full'>
        ...
        <a href='https://www.linkedin.com/in/ejaz-ahmed-9939b027b/' className='bg-[#393e46] p-3 rounded-full'>
        ...
        <a href='https://github.com/Ejaz0000' className='bg-[#393e46] p-3 rounded-full'>
